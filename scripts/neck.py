...
if __name__ == '__main__':
  ...
  if not rospy.has_param('~DataFile'):
    ...
    pubWhole = rospy.Publisher('/ihmc_ros/valkyrie/control/neck_trajectory', NeckTrajectoryRosMessage, queue_size=10)
    ...
    while not rospy.is_shutdown():
      if stop:
        ...
        message = message_converter.convert_dictionary_to_ros_message('ihmc_msgs/NeckTrajectoryRosMessage', data)
